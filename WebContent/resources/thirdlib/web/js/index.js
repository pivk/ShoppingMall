...
layui.config({
	base : "/Cart/resources/thirdlib/web/js/"
	...
	var form = layui.form,
		...
		tab = layui.bodyTab({
			...
			url : "/Cart/resources/thirdlib/web/json/navs.json" //获取菜单json地址
		});
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							'<div class="admin-header-lock-img"><img src="/Cart/ProductType/resources/thirdlib/web/images/face.jpg"/></div>'+
