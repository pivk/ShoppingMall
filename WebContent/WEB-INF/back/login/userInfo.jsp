...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/thirdlib/web/css/user.css" media="all" />
</head>
<body class="childrenBody">
	<form class="layui-form">
		<div class="user_left">
			...
			<div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			    	<input type="text" value="" placeholder="请输入出生年月" lay-verify="required|date" onclick="layui.laydate.render({elem: this,max: laydate.now()})" class="layui-input userBirthday">
			    </div>
			</div>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/thirdlib/web/js/address.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/thirdlib/web/js/user.js"></script>
</body>
</html>