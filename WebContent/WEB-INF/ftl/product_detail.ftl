...
<html>
	<head>
		<meta charset="UTF-8">
		<title>华为畅享6S</title>
		<link rel="stylesheet" type="text/css" href="/Cart/resources/front/css/detail_style.css" />
		<script type="text/javascript">
			...
			function addCart(productId){
				var amount = $("#num").val();
				window.location.href="/Cart/cart/addCart.shtml?productId="+productId+"&amount="+amount;
			}
		</script>
	</head>
	...
	<body>
		...
		<div class="logo_center">
			<div class="left">
				<img src="/Cart/resources/front/img/LOGO.png" />
			</div>
			<div class="center">
			...
			<div class="little_menu">
				<ul>
					<li class="little_menu_left">
						...
						华为（HUAWEI）
						<img src="/Cart/resources/front/img/111.png" />
						</span> &nbsp;&nbsp;&gt;&nbsp;华为畅享6S
					</li>
					<li class="little_menu_right">
						华为官方旗舰店
						<img src="/Cart/resources/front/img/tou.png" /> 联系供应商
					</li>
					<li class="little_menu_bottom">
						<img src="/Cart/resources/front/img/shoucang2.png" /> 联系供应商
					</li>
				</ul>
			</div>
		</div>
			...
			<div class="left">
				<ul>
					<li class="banner_center_left_top">
						<img src="${product.fulUrl}" width="350" height="350"/>
					</li>
					<li class="banner_center_left_center">
						<ul>
							<li class="left_right_nav">
								<img src="/Cart/resources/front/img/left.png" />
							</li>
							...
							<li class="left_right_nav">
								<img src="/Cart/resources/front/img/right.png" />
							</li>
						</ul>
					</li>
					<li class="banner_center_left_bottom">
						<img src="/Cart/resources/front/img/xin.png" />&nbsp;关注&nbsp;&nbsp;
						<img src="/Cart/resources/front/img/enjoy.png" />&nbsp;分享&nbsp;&nbsp;
						<img src="/Cart/resources/front/img/duizhao.png" />&nbsp;对比
					</li>
				</ul>
			</div>
			<div class="right">
				<ul>
					...
					<li class="right_2">
						<ul>
							<li class="right_2_1">
								<img class="img_117" src="/Cart/resources/front/img/117.png" />
							...
							<li class="right_2_2">
								...
								<img src="/Cart/resources/front/img/120.png" />
							</li>
							<li class="right_2_3">
							...
							<li class="right_2_4">
								...
								<img src="/Cart/resources/front/img/119.png" />&nbsp;&nbsp;
								<img src="/Cart/resources/front/img/118.png" />
							</li>
							<li class="right_2_5">
							...
							<li class="right_2_6">
								...
								<img src="/Cart/resources/front/img/xia.png" />
							</li>
						</ul>
					</li>
					<li class="right_3">
				...
				<ul>
					<li>
						<div class="title_center_img">
							<img src="/Cart/resources/front/img/130.png" />
						</div>
					...
					<li>
						<div class="add_img">
							<img src="/Cart/resources/front/img/jia.png" />
						</div>
					</li>
					<li>
						<div class="title_center_img">
							<img src="/Cart/resources/front/img/131.png" />
						</div>
						<div class="title_center_p">
					...
					<li>
						<div class="title_center_img">
							<img src="/Cart/resources/front/img/137.png" />
						</div>
						<div class="title_center_p">
							机灵猫 畅享6S手机壳女防摔带支架保护套
						</div>
					...
					<li>
						<div class="title_center_img">
							<img src="/Cart/resources/front/img/132.png" />
						</div>
						<div class="title_center_p">
					...
					<li>
						<div class="title_center_img">
							<img src="/Cart/resources/front/img/133.png" />
						</div>
						<div class="title_center_p">
							品胜 iPad充电器 移动电源充电
						</div>
					...
					<li>
						<div class="title_center_img">
							<img src="/Cart/resources/front/img/134.png" />
						</div>
						<div class="title_center_p">
					...
					<li>
						<div class="nav_img">
							<img src="/Cart/resources/front/img/135.png" />
						</div>
					</li>
					<li>
						<div class="eq_img">
							<img src="/Cart/resources/front/img/136.png" />
						</div>
					</li>
					<li>
						<div class="add_all">
			...
			<div class="right">
				<ul>
					...
					<li class="de_li_2">
						...
						<span class="care1">
								<img src="/Cart/resources/front/img/xin.png"/>
								关注
							</span>
						</span>
					</li>
		...
		<div class="surper_big">
			...
			<div class="left">
				<div class="left">
					...
					<ul>
						<li>
							<img src="/Cart/resources/front/img/138.png" />
						...
						<li>
							<img src="/Cart/resources/front/img/139.png" />
						...
						<li>
							<img src="/Cart/resources/front/img/140.png" />
						...
						<li>
							<img src="/Cart/resources/front/img/141.png" />
						...
						<li>
							<img src="/Cart/resources/front/img/142.png" />
						...
						<li>
							<img src="/Cart/resources/front/img/143.png" />
						...
						<li>
							<img src="/Cart/resources/front/img/144.png" />
						...
						<li>
							<img src="/Cart/resources/front/img/145.png" />
			...
			<div class="ranking">
				...
				<div class="bottom">
					<ul>
						<li class="ranking_1">
							<img class="brand_ranking" src="/Cart/resources/front/img/yuan1.png"/>
		...
		<div class="more">
			...
			<div class="mb5">
				<ul>
					...
					<li>
						<img src="/Cart/resources/front/img/98.png" />
					</li>
				</ul>
			</div>
			<div class="clearfix"></div>
